...
win.title("Paddle Ball Game") # Giving name to the game.
win.bgcolor('white')    # providing color to the HomeScreen
...
while True:
    ...
    if ball.ycor() > 300:   # Right top paddle Border
        ball.sety(290)
        ball_dy = ball_dy * -1
